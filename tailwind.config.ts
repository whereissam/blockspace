...
export default {
	...
	plugins: [
		...
		plugin(({ addComponents }) => {
			addComponents({
				/* --- Legacy (kept for existing component references) --- */
				".citrus-link": {
					"&:hover": { textDecoration: "underline", textUnderlineOffset: "2px" },
					textDecoration: "none",
				},
				".title": { fontWeight: "600", color: "var(--theme-heading)" },
				...
				/* ======================================================
				   DESIGN SYSTEM — Editorial Component Classes
				   ====================================================== */

				/* --- Typography --- */
				".ds-hero": {
					fontSize: "var(--ds-font-hero)",
					fontWeight: "700",
				...
				".ds-headline": {
					fontSize: "var(--ds-font-headline)",
					fontWeight: "600",
					lineHeight: "var(--ds-leading-tight)",
					color: "var(--theme-heading)",
				},
				".ds-subhead": {
					fontSize: "var(--ds-font-subhead)",
					fontWeight: "700",
				...
				/* --- Category Tag (the editorial wayfinding element) --- */
				".ds-tag": {
					display: "inline-block",
					fontSize: "var(--ds-font-label)",
					fontWeight: "700",
					lineHeight: "1",
					letterSpacing: "var(--ds-tracking-wide)",
					textTransform: "uppercase",
					color: "hsl(var(--theme-accent-base))",
					transition: "color var(--ds-duration-fast) var(--ds-easing)",
					"&:hover": { color: "hsl(var(--theme-accent-two))" },
				},

				/* --- Card (editorial: no shadows, separation via space + borders) --- */
				".ds-card": {
					display: "block",
					borderRadius: "var(--ds-radius-md)",
					transition: "background-color var(--ds-duration-fast) var(--ds-easing)",
					"&:hover": { backgroundColor: "var(--theme-color-50)" },
				},

				/* --- Surface (subtle background regions) --- */
				".ds-surface": {
					backgroundColor: "var(--theme-color-50)",
					borderRadius: "var(--ds-radius-md)",
				},
				".ds-surface-raised": {
					backgroundColor: "var(--theme-color-75)",
					borderRadius: "var(--ds-radius-md)",
				},

				/* --- Divider (thin editorial separator) --- */
				".ds-divider": {
					height: "1px",
					width: "100%",
					backgroundColor: "var(--theme-color-150)",
					border: "none",
				},
				...
				".ds-btn": {
					...
					color: "#fff",
					transition: "background-color var(--ds-duration-fast) var(--ds-easing)",
					"&:hover": { backgroundColor: "var(--ds-brand-hover)" },
				},
				".ds-btn-ghost": {
					display: "inline-flex",
					alignItems: "center",
					...
					transition: "all var(--ds-duration-fast) var(--ds-easing)",
					"&:hover": {
						borderColor: "hsl(var(--theme-accent-base))",
						color: "hsl(var(--theme-accent-base))",
					},
				},

				/* --- Image container (editorial crops) --- */
				".ds-img": {
					overflow: "hidden",
					...
					"& img": {
						...
						height: "100%",
						objectFit: "cover",
						transition: "transform var(--ds-duration-normal) var(--ds-easing)",
					},
				...
				DEFAULT: {
					css: {
						...
						blockquote: {
							...
							"p::before": {
								lineHeight: "1",
								fontFamily: "CascadiaCode, ui-serif, Georgia, serif",
								fontWeight: "500",
								position: "relative",
								content: "'\\201C'",
								fontSize: "1.5rem",
						...
						kbd: {
							color: "var(--theme-text)",
							backgroundColor: "var(--theme-special-lighter)",
							borderColor: "var(--theme-color-100)",
							boxShadow: "0px 2.5px 0px rgba(0,0,0,0.25)",
						},
						hr: {
							borderTopWidth: "1px",
							borderStyle: "solid",
							borderColor: "var(--theme-color-200)",
						},
						...
						".aside": {
							...
							marginBottom: "1rem",
							padding: "1rem",
							borderInlineStartWidth: "0.625rem",
							borderRadius: "0.5rem",
							borderColor: "var(--admonition-color)",
							".aside-title": {
								fontWeight: "700",
								fontSize: "1rem",
								display: "flex",
				...
				citrus: {
					css: {
						...
						h3: {
							...
							marginBottom: "0.6em",
							paddingTop: "0.5em",
							borderTop: "1px solid var(--theme-color-150)",
						},
						h4: {
							fontSize: "1.2em",
							fontWeight: "700",
